      ...
      <div className="mt-8 w-full">
        <div className="flex flex-col md:flex-row gap-5 w-full">
          ...
          <div className={`flex flex-col ${isOpen ? 'block' : 'hidden'} md:flex md:w-1/5 w-full`}>
            <div className={`flex flex-col pb-20 text-base tracking-wide leading-6 text-neutral-500 ${isOpen ? 'block' : 'hidden'} md:block bg-white dark:bg-gray-800 rounded-tr-lg`}>
