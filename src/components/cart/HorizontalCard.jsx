...
const HorizontalCard = ({
  ...
  return (
    <motion.div 
      ...
      initial="hidden"
      variants={variants}
      className="my-5 mx-auto w-full max-w-[97%] border dark:border-none bg-white dark:bg-gray-700 rounded-xl transition-all duration-500 ease-in-out transform hover:scale-105 hover:shadow-xl"
